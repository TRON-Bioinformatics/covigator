...
update variant_v13 set variant_type='SNV' where length = 0;
update variant_v13 set variant_type='DELETION' where length < 0;
update variant_v13 set variant_type='INSERTION' where length > 0;
